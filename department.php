				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group"
							<label for="department" class="control-label">Equipment</label>
							<input type="text" class="form-control" id="department" name="department" placeholder="Equipment" required>			
						</div>
						<div class="form-group">
							<label for="status" class="control-label">Type</label>				
							<select id="status" name="status" class="form-control">
							<option value="1">Hardware</option>				
							<option value="2">Softaware</option>
							<option value="3">N etwork</option>	
							</select>						
						</div>						
